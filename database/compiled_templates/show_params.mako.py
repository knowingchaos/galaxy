...
_magic_number = 6
_modified_time = 1382702999.089258
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f1f10140350', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f1f10140350')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f1f10140350')._populate(_import_ns, [u'render_msg'])
        ...
        __M_writer(u'</td></tr>\n        <tr><td>Created:</td><td>')
        # SOURCE LINE 112
        __M_writer(unicode(hda.create_time.strftime("%b %d, %Y")))
        __M_writer(u'</td></tr>\n')
        # SOURCE LINE 114
        ...
        if params_objects and tool:
            ...
            # SOURCE LINE 141
            __M_writer(u'            <tr><td colspan="2">Unable to load parameters.</td></tr>\n')
            # SOURCE LINE 142
        else:
            # SOURCE LINE 143
            __M_writer(u'            <tr><td colspan="2">No parameters.</td></tr>\n')
            pass
        # SOURCE LINE 145
        __M_writer(u'    </tbody>\n</table>\n')
        # SOURCE LINE 147
