...
_magic_number = 6
_modified_time = 1383205887.102535
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7c7c510', context._clean_inheritance_tokens(), templateuri=u'/display_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7c7c510')] = ns

    # SOURCE LINE 1
    ns = runtime.TemplateNamespace('__anon_0x7c7c410', context._clean_inheritance_tokens(), templateuri=u'./grid_base.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7c7c410')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7c7c510')._populate(_import_ns, [u'render_message'])
        _mako_get_namespace(context, '__anon_0x7c7c410')._populate(_import_ns, [u'*'])
