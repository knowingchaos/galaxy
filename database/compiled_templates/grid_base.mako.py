...
_magic_number = 6
_modified_time = 1383281609.7782149
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 132
    ns = runtime.TemplateNamespace('__anon_0x7f2d501c4a10', context._clean_inheritance_tokens(), templateuri=u'./grid_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f2d501c4a10')] = ns

    # SOURCE LINE 15
    ns = runtime.TemplateNamespace('__anon_0x7a80190', context._clean_inheritance_tokens(), templateuri=u'/display_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7a80190')] = ns

    # SOURCE LINE 16
    ns = runtime.TemplateNamespace('__anon_0x7a80c90', context._clean_inheritance_tokens(), templateuri=u'/refresh_frames.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7a80c90')] = ns

    # SOURCE LINE 358
    ns = runtime.TemplateNamespace('__anon_0x7f2d40062e50', context._clean_inheritance_tokens(), templateuri=u'/display_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f2d40062e50')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f2d501c4a10')._populate(_import_ns, [u'*'])
        _mako_get_namespace(context, '__anon_0x7a80190')._populate(_import_ns, [u'render_message'])
        _mako_get_namespace(context, '__anon_0x7a80c90')._populate(_import_ns, [u'handle_refresh_frames'])
        _mako_get_namespace(context, '__anon_0x7f2d40062e50')._populate(_import_ns, [u'get_class_plural'])
