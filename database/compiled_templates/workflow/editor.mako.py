...
_magic_number = 6
_modified_time = 1383213831.962647
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 1021
    ns = runtime.TemplateNamespace('__anon_0x7f972010ee50', context._clean_inheritance_tokens(), templateuri=u'/tagging_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f972010ee50')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f972010ee50')._populate(_import_ns, [u'render_individual_tagging_element'])
...
def render_right_panel(context):
    ...
    try:
        ...
        # SOURCE LINE 1016
        __M_writer(u'            <div id="workflow-name-area" class="form-row">\n                <label>Name:</label>\n                <span id="workflow-name" class="tooltip editable-text" title="Click to rename workflow">')
        # SOURCE LINE 1018
        __M_writer(filters.html_escape(unicode(h.to_unicode( stored.name ) )))
        __M_writer(u'</span>\n            </div>\n')
        # SOURCE LINE 1021
...
def render_javascripts(context):
    ...
    try:
        ...
        # SOURCE LINE 204
        __M_writer(u'            "Auto Re-layout": layout_editor,\n')
        # SOURCE LINE 206
