...
_magic_number = 6
_modified_time = 1383707033.1623499
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7fab8811d390', context._clean_inheritance_tokens(), templateuri=u'/dataset/display.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7fab8811d390')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7fab8811d390')._populate(_import_ns, [u'render_deleted_data_message'])
...
def render_javascripts(context):
    ...
    try:
        ...
        # SOURCE LINE 22
        __M_writer(unicode(h.to_json_string( trans.security.encode_dict_ids( dataset.get_api_value() ) )))
        __M_writer(u', \n                        {\n                            url_viz: "')
        # SOURCE LINE 24
