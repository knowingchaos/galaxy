...
_magic_number = 6
_modified_time = 1382608672.255805
_template_filename='templates/webapps/galaxy/tool_form.mako'
_template_uri='tool_form.mako'
_template_cache=cache.Cache(__name__, _modified_time)
_source_encoding='ascii'
_exports = ['stylesheets', 'javascripts', 'do_inputs', 'row_for_rerun', 'row_for_param']
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f2edc0c2e10', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f2edc0c2e10')] = ns

    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x7f2edc0c2b10', context._clean_inheritance_tokens(), templateuri=u'/base_panels.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f2edc0c2b10')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f2edc0c2e10')._populate(_import_ns, [u'render_msg'])
        _mako_get_namespace(context, '__anon_0x7f2edc0c2b10')._populate(_import_ns, [u'overlay'])
    ...
    # Name of the tool in lower case
        ...
        if trans.app.config.biostar_url:
            # SOURCE LINE 325
            __M_writer(u'            <!-- BioStar links -->\n            <span class="pull-right"><a href="')
            # SOURCE LINE 326
            __M_writer(unicode(h.url_for( controller='biostar', action='biostar_tool_question_redirect', tool_id=tool.id )))
            __M_writer(u'" target="_blank" class="fa-icon-question-sign tooltip" data-original-title="Ask a question about this tool"></a></span>\n            <!-- End of BioStar links -->\n')
            pass
        # SOURCE LINE 329
