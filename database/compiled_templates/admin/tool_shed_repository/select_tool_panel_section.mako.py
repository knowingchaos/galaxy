...
_magic_number = 6
_modified_time = 1384082586.502537
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f1ba0042b10', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f1ba0042b10')] = ns

    # SOURCE LINE 4
    ns = runtime.TemplateNamespace('__anon_0x7f1ba0042710', context._clean_inheritance_tokens(), templateuri=u'/admin/tool_shed_repository/common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f1ba0042710')] = ns

    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x7f1ba0042e50', context._clean_inheritance_tokens(), templateuri=u'/admin/tool_shed_repository/common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f1ba0042e50')] = ns

    # SOURCE LINE 5
    ns = runtime.TemplateNamespace('__anon_0x7f1ba00428d0', context._clean_inheritance_tokens(), templateuri=u'/webapps/tool_shed/repository/common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f1ba00428d0')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f1ba0042b10')._populate(_import_ns, [u'render_msg'])
        _mako_get_namespace(context, '__anon_0x7f1ba0042710')._populate(_import_ns, [u'render_readme_section'])
        _mako_get_namespace(context, '__anon_0x7f1ba0042e50')._populate(_import_ns, [u'render_dependencies_section'])
        _mako_get_namespace(context, '__anon_0x7f1ba00428d0')._populate(_import_ns, [u'*'])
