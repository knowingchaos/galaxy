...
_magic_number = 6
_modified_time = 1383224099.7208149
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 1
    ns = runtime.TemplateNamespace('__anon_0x7f9720193590', context._clean_inheritance_tokens(), templateuri=u'/display_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f9720193590')] = ns

    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f97341707d0', context._clean_inheritance_tokens(), templateuri=u'/root/history_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f97341707d0')] = ns

    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x7f9734170090', context._clean_inheritance_tokens(), templateuri=u'/tagging_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f9734170090')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f9720193590')._populate(_import_ns, [u'get_history_link', u'get_controller_name'])
        _mako_get_namespace(context, '__anon_0x7f97341707d0')._populate(_import_ns, [u'render_dataset'])
        _mako_get_namespace(context, '__anon_0x7f9734170090')._populate(_import_ns, [u'render_individual_tagging_element', u'render_community_tagging_element'])
