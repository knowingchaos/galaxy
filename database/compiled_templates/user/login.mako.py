...
_magic_number = 6
_modified_time = 1383917753.0677149
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 23
    ns = runtime.TemplateNamespace('__anon_0x8746a10', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x8746a10')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x8746a10')._populate(_import_ns, [u'render_msg'])
...
def render_render_login_form(context,form_action=None):
    ...
    try:
        ...
        # SOURCE LINE 74
        __M_writer(u'\n\n\n    <div class="toolForm" style="padding-top:200px; padding-left:100px;" >\n\t\t\t\t<table width="1120" border="0" cellspacing="0" cellpadding="0"  >\n\t\t\t\t<tr>\n\t\t\t\t<td width ="50%">\n\t\t\t\t<center><h2>Galaxy Project</h2></center>\n\t\t\t\t</td>\n\t\t\t\t<td width ="50%">\n\t\t\t\t</td>\n\t\t\t\t</tr>\n      <tr>\n     <td width="50%"><center><img  src="')
        # SOURCE LINE 87
        __M_writer(unicode(h.url_for('/static/images/login2.png')))
        __M_writer(u'"></center></td>\n     <td width="50%" height="210" style="padding-left:60px;"> \n\n\t     <form name="login" id="login" action="')
        # SOURCE LINE 90
