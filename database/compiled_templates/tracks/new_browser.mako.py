...
_magic_number = 6
_modified_time = 1383035230.4863451
_template_filename='templates/webapps/galaxy/tracks/new_browser.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 22
        __M_writer(unicode(h.url_for( controller='user', action='dbkeys', use_panels=True )))
