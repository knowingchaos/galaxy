...
_magic_number = 6
_modified_time = 1382687135.4901259
_template_filename='templates/webapps/galaxy/tracks/add_to_viz.mako'
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f47f84171d0', context._clean_inheritance_tokens(), templateuri=u'../grid_base.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f47f84171d0')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f47f84171d0')._populate(_import_ns, [u'*'])
