...
cwd = os.getcwd()
tool_shed_home_directory = os.path.join( cwd, 'test', 'local_shed' )
...
def main():
    ...
    if 'TOOL_SHED_TEST_DBPATH' in os.environ:
        ...
        shed_db_path = os.path.join( cwd, 'database' )
    ...
    if 'TOOL_SHED_TEST_DBURI' in os.environ:
        ...
        toolshed_database_connection = 'postgresql://yquan:hy!yquan@localhost/dbgalaxy_shed'
    if 'GALAXY_TEST_DBURI' in os.environ:
        ...
        galaxy_database_connection = 'postgresql://yquan:hy!yquan@localhost/dbgalaxy_tmp'
    kwargs = {}
    ...
    hgweb_config_dir = cwd+"/database/hgconfig"
    ...
    toolshedapp = ToolshedUniverseApplication( admin_users = 'admin@hygenomics.com',
    ...
    if 'TOOL_SHED_TEST_OMIT_GALAXY' not in os.environ:
        ...
        galaxyapp = GalaxyUniverseApplication( allow_user_creation = True,
                                               allow_user_deletion = True,
                                               admin_users = 'admin@hygenomics.com',
