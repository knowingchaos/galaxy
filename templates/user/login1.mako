...
<%def name="render_login_form( form_action=None )">
    ...
    <div class="toolForm">
        <div class="toolFormTitle"><center><h1>Galaxy Project</h1></center></div>
		
		
				<table width="1120" border="0" cellspacing="0" cellpadding="0" align = "center">
      <tr>
     <td width="50%"><center><img  src="${h.url_for('/static/images/login2.png')}"></center></td>
     <td width="50%" height="210" style="padding-left:100px;"  background="${h.url_for('/static/images/table_bg.png')}"> 
	     ...
	     <form name="login" id="login" action="${form_action}" method="post" >
			...
			<tr>
				...
				<td><input type="button" value="Register" onclick="location.href='${h.url_for( controller='user', action='create', cntrller='user' )}'"></td>
			</tr>
			</table>
            </div>
        </form>
